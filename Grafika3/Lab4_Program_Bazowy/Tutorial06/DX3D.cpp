...
HRESULT InitDevice()
{
    ...
    {
        { XMFLOAT3(-0.25f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //0
        { XMFLOAT3(0.25f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //1
        { XMFLOAT3(0.25f, 1.0f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //2
        { XMFLOAT3(-0.25f, 1.0f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //3
        { XMFLOAT3(-0.25f, -2.0f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //4
        { XMFLOAT3(-0.25f, -2.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //5
        { XMFLOAT3(2.25f, -2.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //6
        { XMFLOAT3(2.25f, -2.0f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //7
        { XMFLOAT3(1.75f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //8
        { XMFLOAT3(2.25f, 1.0f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //9
        { XMFLOAT3(2.25f, 1.0f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //10
        { XMFLOAT3(1.75f, 1.0f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //11
        { XMFLOAT3(1.75f, -1.5f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //12
        { XMFLOAT3(0.25f, -1.5f, 1.25f), XMFLOAT3(0.0f, 0.0f, 1.0f) },  //13
        { XMFLOAT3(0.25f, -1.5f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //14
        { XMFLOAT3(1.75f, -1.5f, 0.25f), XMFLOAT3(0.0f, 0.0f, -1.0f) },  //15
    };
...
void Render()
{
    ...
    XMVECTOR At = XMVectorSet(0.5f + offset_x, 0.0f + offset_y, 0.0f, 0.0f);
    ...
    //DODANE//NOWA LITERA//NOWA LITERA//NOWA LITERA//

    g_World = g_World * XMMatrixTranslation(3, 0, 0);

    // Setup our lighting parameters
    vLightColors = XMFLOAT4(0.5f, 1.0f, 2.5f, 1.0f); //zmiana koloru litery
